...
@property(readonly, nonatomic, strong, nullable) NSDictionary *metadata;
...
/// @see RFSLivenessConfiguration.metadata.
@property(readwrite, nonatomic, strong, nullable) NSDictionary *metadata;
/// @see RFSLivenessConfiguration.vibrateOnSteps.
