...
/// Enables vibration during Face Capture processing. Defaults to `true`.
@property(readonly, nonatomic, assign) BOOL vibrateOnSteps;
/// Enables 'remove occlusion' animation & hint. Defaults to `true`.
@property(readonly, nonatomic, assign) BOOL detectOcclusion;
...
@property(readwrite, nonatomic, nullable) NSNumber *holdStillDuration;
/// @see RFSFaceCaptureConfiguration.vibrateOnSteps.
@property(readwrite, nonatomic, assign) BOOL vibrateOnSteps;
/// @see RFSFaceCaptureConfiguration.detectOcclusion.
@property(readwrite, nonatomic, assign) BOOL detectOcclusion;
