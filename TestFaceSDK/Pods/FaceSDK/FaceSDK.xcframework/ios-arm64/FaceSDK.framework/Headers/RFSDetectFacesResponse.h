...
typedef NS_ERROR_ENUM(RFSDetectFacesErrorDomain, RFSDetectFacesErrorCode) {
  RFSDetectFacesErrorCodeImageEmpty,
  RFSDetectFacesErrorCodeFaceNotDetected,
  RFSDetectFacesErrorCodeNoLicense,
  RFSDetectFacesErrorCodeNotInitialized,
  RFSDetectFacesErrorCodeCommandIsNotSupported,
  RFSDetectFacesErrorCodeCommandParamsReadError,
  RFSDetectFacesErrorCodeProcessingFailed,
  RFSDetectFacesErrorCodeRequestFailed,
